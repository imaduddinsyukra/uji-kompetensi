...
<div id="contentbaru" align="center">
     <h3>EDIT DATA BIDANG STUDI</h3>
     <p>
       <?php
include '../koneksi.php';
$kode_guru = $_GET['kode_guru']; //get the no which will updated
$queryy = mysql_query("SELECT * FROM guru WHERE kode_guru = '$kode_guru'"); //get the data that will be updated
     ...
     <form action="update_guru.php" method="post">
       ...
       <table width="525" border="0">
         <tr>
           <td>KODE GURU</td>
           <td>:</td>
           <td><input type="hidden" name="kode_guru" id="kode_guru" value="<?php echo $que['kode_guru']; ?>" /><?php echo $que['kode_guru']; ?></td>
         </tr>
         <tr>
...
?></td>
         ...
         <tr>
           <td>NIP GURU</td>
           <td>:</td>
           <td><input type="text" name="nip" id="nip" value="<?php echo $que['nip']; ?>"/></td>
         </tr>
         <tr>
           <td>NAMA GURU</td>
           <td>:</td>
           <td><input type="text" name="nama_guru" id="nama_guru" value="<?php echo $que['nama_guru']; ?>" /></td>
         </tr>
         <tr>
           <td>ALAMAT</td>
           <td>:</td>
           <td><input type="text" name="alamat_guru" id="alamat_guru" value="<?php echo $que['alamat_guru']; ?>" /></td>
         </tr>
         <tr>
           <td>NO. TELEPON</td>
           <td>:</td>
           <td><input type="text" name="telp_guru" id="telp_guru" value="<?php echo $que['telp_guru']; ?>" /></td>
         </tr>
