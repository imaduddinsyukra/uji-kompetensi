...
<title>TAMBAH KOMPETENSI KEAHLIAN</title>
<style type="text/css">
<!--
.header {
	position: absolute;
...
<div class="tabel">
     <h3>TAMBAH DATA KOMPETENSI KEAHLIAN</h3>
     <p>&nbsp;</p>
  ...
  include("../koneksi.php");  ?>
       <table width="490" border="0">
         <tr>
           ...
           <td>:</td>
           <td><input type="text" name="kode_kk" id="kode_kk" /></td>
         </tr>
         <tr>
           <td>KODE BIDANG KEAHLIAN</td>
           <td>:</td>
           <td><?php echo "<select name=\"kode_mata_diklat\" id=\"kode_mata_diklat\">";
    $myquery="select kode_mata_diklat from mata_diklat";
    $daftar=mysql_query($myquery) or die (mysql_error());
	
    while($databid=mysql_fetch_object($daftar))
    {
        //perulangan menampilkan data
        echo "<option value=\"$databid->kode_mata_diklat\">$databid->kode_mata_diklat</option>";
...
?></td>
         ...
         <tr>
           ...
           <td>:</td>
           <td><input type="text" name="nama_kompetensikeahlian" id="nama_kompetensikeahlian" /></td>
         </tr>
       </table>
       <p>&nbsp;        </p>
       <p>
