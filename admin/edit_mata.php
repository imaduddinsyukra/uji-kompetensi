...
<div id="contentbaru" align="center">
     ...
     <p>
       <?php
include '../koneksi.php';
$kode_mata_diklat = $_GET['kode_mata_diklat']; //get the no which will updated
$query = mysql_query("SELECT * FROM mata_diklat WHERE kode_mata_diklat = '$kode_mata_diklat'"); //get the data that will be updated
$r=mysql_fetch_array($query)

 ?>
     </p>
     <form action="update_mata.php" method="post">
       <br />
       <table width="387" border="0">
         <tr>
           <td>KODE MATA DIKLAT</td>
           <td>:</td>
           <td><input type="hidden" name="kode_mata_diklat" id="kode_mata_diklat" value="<?php echo $r['kode_mata_diklat']; ?>" /><?php echo $r['kode_mata_diklat']; ?></td>
         </tr>
         <tr>
           <td>NAMA BIDANG STUDI</td>
           <td>:</td>
           <td><input type="text" name="nama_mata_diklat" id="nama_mata_diklat" value="<?php echo $r['nama_mata_diklat']; ?>" /></td>
         </tr>
       </table>
       <p>&nbsp;        </p>
       <p>
