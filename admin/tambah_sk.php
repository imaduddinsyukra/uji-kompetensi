...
<title>TAMBAH STANDAR KOMPETENSI</title>
<style type="text/css">
<!--
.header {
	position: absolute;
...
<div class="tabel">
<p>&nbsp;</p>
<form action="proses_sk.php" method="post">
       <br />
       <?php
  include("../koneksi.php");  ?>
       <table width="591" border="0">
         <tr>
           ...
           <td>:</td>
           <td><input type="text" name="kode_sk" id="kode_sk" /></td>
         </tr>
         <tr>
...
?></td>
         ...
         <tr>
           ...
           <td>:</td>
           <td><input type="text" name="nama_sk" id="kelas_sk" /></td>
         </tr>
         <tr>
           <td>KELAS</td>
           <td>:</td>
           <td><select name="kelas_sk" id="kelas_sk">
