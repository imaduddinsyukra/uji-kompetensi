	 ...
	 ?>
       <table width="396" border="0">
         ...
         <tr>
           <td>Password Baru</td>
           <td>:</td>
           <td><input name="pass_baru" type="pass" />
             &nbsp;
             <input type="hidden" name="kode_guru" value="<?php echo $kode_guru ; ?>" /></td>
         </tr>
         <tr>
           <td>Ulangi Password baru</td>
           <td>:</td>
           <td><input name="pass_baru2" type="pass" />
             &nbsp;</td>
         </tr>
       </table>
       <p>&nbsp;</p>
       <p>
         <input type="submit" name="Ubah" id="Ubah" value="Ganti" />
       </p>
     </form>
     <p><br>
     </p>
