...
<div class="TABEL">
 <div id="contentbaru" align="center">
     ...
     <form enctype="multipart/form-data" action="proses_siswa.php" method="post">
       <?php
  include("../koneksi.php");  ?>
       <table width="479" border="0">
         <tr>
           <td>NISN/NIS SISWA</td>
           <td>:</td>
         ...
         <tr>
           <td>TGL LAHIR</td>
           <td>:</td>
           <td><input type="date" name="tgl_lahir" id="calendar" /></td>
         </tr>
         <tr>
           <td>ALAMAT</td>
           <td>:</td>
           <td>
            <textarea name="alamat_siswa" id="alamat_siswa" cols="30" rows="3"></textarea></td>
         </tr>
         <tr>
           <td>FOTO</td>
           <td>:</td>
           <td><input type="file" name="gilang"></td>
         </tr>
         <tr>
