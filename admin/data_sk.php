...
<div id="contentbaru" align="center">
     <h3>DATA STANDAR KOMPETENSI</h3>
          <p align="left"><a href="tambah_sk.php">Tambah Data Standar Kompetensi</a></p>
     <p>&nbsp;</p>
     <table width="621" border="1">
       <?php
include ("../koneksi.php");
$sqll = "select * from standar_kompetensi";
$resultt = mysql_query($sqll);
if(mysql_num_rows($resultt) > 0){
?>
       <tr>
         <th width="17"><div align="center">NO</div>
         <th width="98"><div align="center">KODE SK</div>
         <th width="270"><div align="center">NAMA STANDAR KOMPETENSI</div>
         <th width="123"><div align="center">KODE KK</div>
...
while($siswaa = mysql_fetch_array($resultt)){?>
       <tr>
         ...
         <td width="34"><div align="center"><a href="edit_sk.php?kode_sk=<?php echo $siswaa['kode_sk']; ?>" > Edit</a></div></td>
         <td width="39"><div align="center"><a href="hapus_sk.php?kode_sk=<?php echo $siswaa['kode_sk']; ?>" onClick="return confirm('Apakah Anda Yakin Hapus Data?')" >Hapus</a></div></td>
       </tr>
       <?php } ?>
     </table>
     <?php
