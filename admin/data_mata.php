...
<div id="contentbaru" align="center">
     <h3>DATA MATA DIKLAT</h3>
     <p align="left"><a href="tambah_mata.php">TAMBAH MATA DIKLAT</a></p>
     <p>&nbsp;</p>
     <table width="532" border="1">
       <?php
include ("../koneksi.php");
$sqll = "select *from mata_diklat";
$resultt = mysql_query($sqll);
if(mysql_num_rows($resultt) > 0){
?>
       <tr>
         <th width="31"><div align="center">NO
         </div>
         <th width="154"><div align="center">KODE BIDANG STUDI</div>
         <th width="297"><div align="center">NAMA BIDANG STUDI</div>
...
while($siswaa = mysql_fetch_array($resultt)){?>
       <tr>
         ...
         <td><?php echo $siswaa['nama_mata_diklat'];?></td>
         <td width="25"><div align="center"><a href="edit_mata.php?kode_mata_diklat=<?php echo $siswaa['kode_mata_diklat']; ?>" > Edit</a></div></td>
         <td width="43"><div align="center"><a href="hapus_mata.php?kode_mata_diklat=<?php echo $siswaa['kode_mata_diklat']; ?>" onClick="return confirm('Apakah Anda Yakin Hapus Data?')">Hapus</a></div></td>
