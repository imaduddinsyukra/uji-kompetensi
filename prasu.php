...
$nisn = $_GET['nisn'];
$sqll = "SELECT no,nisn, nama_siswa, nama_guru, kode_sk,nama_sk, nilai_angka, nilai_huruf FROM nilai inner join siswa USING(nisn) inner join guru using(kode_guru) inner join standar_kompetensi using (kode_sk) where nisn = $nisn";
