<?php
  ...
  else { $username = $_SESSION['kode_guru']; }
  require_once("../koneksi.php");
  $query = mysql_query("SELECT * FROM admin WHERE kode_guru = '$username'");
...
<body onload="MM_preloadImages('../images/hampir-fix_12.jpg')">
...
<div class="logout"><a href="logoutguru.php"><img src="../images/hampir-fix_11.jpg" name="logout" width="120" height="30" border="0" id="logout" /></a></div>
<div class="tabel">
<div id="contentbaru" align="center">
  ...
  include("../koneksi.php");  ?>
       ...
       <table width="630" border="0">
         <tr>
           <td width="215">NIS SISWA</td>
           <td width="6">:</td>
           <td width="395"><input type="text" name="nisn" id="nisn" /></td>
         </tr>
         <tr>
           <td>KODE GURU</td>
           <td>:</td>
    ...
    $myquery="select kode_sk from standar_kompetensi";
    $daftar=mysql_query($myquery) or die (mysql_error());
	
    while($databid=mysql_fetch_object($daftar))
    {
        //perulangan menampilkan data
        echo "<option value=\"$databid->kode_sk\">$databid->kode_sk</option>";
...
?></td>
         ...
         <tr>
           <td>NILAI</td>
           <td>:</td>
           <td><input type="text" name="nilai_angka" id="nilai_angka" /></td>
         </tr>
       </table>
       <p>&nbsp;        </p>
       <p>
